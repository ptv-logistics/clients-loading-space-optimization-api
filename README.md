# Clients for the Loading Space Optimization API (Version 1.2)
...
* **TypeScript:** Please add the following dependencies to your project
 ...
 &nbsp;  
 &nbsp;  
 Please refer to our [Loading Space Optimization API](https://developer.myptv.com/en/documentation/loading-space-optimization-api/quick-start-loading-space-optimization-api) documentation.