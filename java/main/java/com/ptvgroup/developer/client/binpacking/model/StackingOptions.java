...
public class StackingOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Specifies if it is allowed to stack items of a stop above items of the next stops. Only relevant if unloadingSequence is used.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stackingRestrictions, stackOnTopOfNextStops);
  }
