...
namespace PTV.Developer.Clients.binpacking.Model
{
    ...
    public partial class ItemsToUnload : IEquatable<ItemsToUnload>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ItemsToUnload);
        }

        /// <summary>
        /// Returns true if ItemsToUnload instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemsToUnload to be compared</param>
        /// <returns>Boolean</returns>
