...
namespace PTV.Developer.Clients.binpacking.Model
{
    ...
    public partial class ItemSurfaceLoads : IEquatable<ItemSurfaceLoads>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ItemSurfaceLoads);
        }

        /// <summary>
        /// Returns true if ItemSurfaceLoads instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemSurfaceLoads to be compared</param>
        /// <returns>Boolean</returns>
