...
namespace PTV.Developer.Clients.binpacking.Model
{
    ...
    public partial class BinPackingOptions : IEquatable<BinPackingOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="unloadingSequence">Specifies the sequence of items or group of items to be unloaded. The first element of this sequence will be unloaded first (and loaded last). Please note that this option can only be used the case a single bin is defined..</param>
        ...
        /// </summary>
        /// <value>Specifies the sequence of items or group of items to be unloaded. The first element of this sequence will be unloaded first (and loaded last). Please note that this option can only be used the case a single bin is defined.</value>
